# Note, this assignment is to fix code errors,
# here is the fixed ex25, below will be the fixed ex24
'''
...
# to use the following commands, you have to call them from ex26
